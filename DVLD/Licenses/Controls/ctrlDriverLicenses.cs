...
namespace DVLD
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There is no driver linked to the person with ID: " + PersonID, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void cmsInterenationalLicenseHistory_Click(object sender, EventArgs e)
        {
