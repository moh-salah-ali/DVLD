...
namespace DVLD_BusinessLayer
{
    public class clsTestAppointment
    {
        ...
        public static DataTable GetTestAppointmentsForLocalDrivingLicenseApplicationAndTestType(int LocalDrivingLicenseApplicationID, clsTestType.enTestType TestTypeID)
        {
            return clsTestAppointmentData.GetTestAppointmentsForLocalDrivingLicenseApplicationAndTestType(LocalDrivingLicenseApplicationID, (int)TestTypeID);
        ...
        {
            return clsTestAppointmentData.HadPassedTest(LocalDrivingLicenseApplicationID, TestTypeID);
        }
