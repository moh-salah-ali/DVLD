...
namespace DVLD_BusinessLayer
{
    public class clsApplication
    {
        ...
        public static int GetCompletedApplicationIDForLicenseClass(int PersonID, clsApplication.enApplicationType ApplicationTypeID, int LicenseClassID)
        {
            return clsApplicationData.GetCompletedApplicationIDForLicenseClass(PersonID, (int)ApplicationTypeID, LicenseClassID);
        }
